...
class TestInsertTasksIgnoreDuplicateNames(unittest.TestCase):
    ...
    @patch('furious.context.context._insert_tasks')
    def test_insert_tasks_ignore_duplicate_names_relays_parms(self,
        ...
        expected.
        """
        from furious.context.context import _insert_tasks_ignore_duplicate_names

        _insert_tasks_ignore_duplicate_names(['1'], 'queue', 'arg1', foo='bar')
    ...
    def test_insert_tasks_ignore_duplicate_names_raises(self, mock_add):
        ...
        inserted = _insert_tasks_ignore_duplicate_names(tasks, 'queue')
